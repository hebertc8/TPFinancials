...
export class MapComponent implements OnDestroy {
  ...
  options = {
    ...
    maxZoom: 6,
    zoomControl: true,
    center: L.latLng({ lat: 4.570868, lng: -74.297333 }),
  ...
  constructor(private ecMapService: SummaryService,
  ...
  private highlightFeature(featureLayer) {
    if (featureLayer) {
      if (featureLayer.feature.id == 'COL' || featureLayer.feature.id == 'PER' || featureLayer.feature.id == 'GUY') {
