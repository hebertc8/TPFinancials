...
export class MainComponent implements OnInit {
  ...
  public spinnerGraphic: Boolean = true;
  ...
  constructor(private requets: RequestsService,
    ...
    this.getDetailCost(this.market, this.campaign, this.client, 8);
    this.getListFilters();
    ...
    this.summaryservice.getSummaryEuro(year, month, country, market, campaign, client, caseType).then((res: any) => {
      ...
      if (Object.keys(res.Result[0]).length !== 0) {
        if (caseType == 2) {
          ...
          this.chartOptions = {
            series: [res.Result[0].PORGMEUR, res.Result[0].PORGMEURRFT],
            chart: {
              height: 300,
              type: "radialBar"
            },
          ...
          // this.barChartData[0].data.push(res.Result[0].NetRevenueEUR);
          // this.barChartData[1].data.push(res.Result[0].DirectCostEUR);
          // this.barChartData[2].data.push(res.Result[0].NetRevenueEUROB);
          // this.barChartData[3].data.push(res.Result[0].DirectCostEUROB);
          // this.barChartData[4].data.push(res.Result[0].NetRevenueEURRFT);
          // this.barChartData[5].data.push(res.Result[0].DirectCostEURRFT);
          ...
          // this.barChartDataHor[0].data.push(res.Result[0].NetRevenueEURRFT);
          // this.barChartDataHor[1].data.push(res.Result[0].NetRevenueEUROB);
          // this.barChartDataHor[2].data.push(res.Result[0].NetRevenueEUR);
  ...
  getAllData(year, month, country, market, campaign, client) {
    ...
    this.getSummaryEuro(year, month, country, market, campaign, client, 5);
    // this.getSummaryEuro(year, month, country, market, campaign, client, 6);
    // this.getSummaryEuro(year, month, country, market, campaign, client, 7);
